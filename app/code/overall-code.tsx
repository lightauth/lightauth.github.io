      ...
      tabs: [
        {
          ...
          name: "npm",
          title: "NPM",
          codeString: "npm install @light-auth/tanstack-react-start",
          language: "sh",
        },
        {
          image: <Image src="/yarn.svg" alt="Yarn Logo" width={12} height={12} className="w-5 h-5 p-0 m-0" />,
          name: "yarn",
          title: "Yarn",
          codeString: "yarn add @light-auth/tanstack-react-start",
          language: "sh",
        },
        {
          image: <Image src="/pnpm.svg" alt="PNPM Logo" width={12} height={12} className="w-5 h-5 p-0 m-0" />,
          name: "pnpm",
          title: "PNPM",
          codeString: "pnpm add @light-auth/tanstack-react-start",
          language: "sh",
        },
      ],
    },
